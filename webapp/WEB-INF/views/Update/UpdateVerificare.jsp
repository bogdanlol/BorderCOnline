...
<title>Update Masina </title>
   ...
   <body>
      <sql:setDataSource var = "snapshot" driver = "com.mysql.jdbc.Driver"
         ...
         UPDATE Verificare SET codv=<%= request.getParameter("codv")%>, codp=<%= request.getParameter("codp")%>, codm= <%= request.getParameter("codm")%>,codo =<%= request.getParameter("codo")%>,orav ="<%= request.getParameter("orav")%>",orap="<%= request.getParameter("orap")%>" WHERE codv=<%= request.getParameter("codv1")%> 
      </sql:update>
      Update Succesful!
       <br />
         <sql:setDataSource var = "snapshot" driver = "com.mysql.jdbc.Driver"
