...
<title>Inserare Persoana </title>
   ...
   <body>
      <sql:setDataSource var = "snapshot" driver = "com.mysql.jdbc.Driver"
         ...
         INSERT INTO Persoana VALUES (  <%= request.getParameter("codp")%>,   "<%= request.getParameter("nume")%>", "<%= request.getParameter("pren")%>", <%= request.getParameter("varsta")%>, "<%= request.getParameter("cnp")%>", <%= request.getParameter("codm")%>);
      </sql:update>
      Insert Succesful!
       <br />
